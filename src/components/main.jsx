    ...
    return (
        <div className="h-screen relative">
            ...
            <div className="text-white text-center h-full">
                <div className='pt-12'>
                    <div className='bg-slate-500 bg-opacity-50 pt-8 text-2xl font-serif'>
                        Our Contracting Partners in Revelstoke BC and surrounding areas
                    </div></div>
                <div className="h-3/5">
                    <div className='bg-slate-500 bg-opacity-50 h-3/5'>
                        <ImageSlider className='border-4' slides={SliderData} />
                    </div><div className='pt-0'>
                        <div className='bg-slate-500 bg-opacity-50 pt-12 text-2xl'>
